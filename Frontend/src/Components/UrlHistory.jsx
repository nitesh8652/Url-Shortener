          ...
          <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            {reversedUrls.map((url) => (
              <tr key={url._id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                ...
                <td className="px-6 py-4 max-w-sm text-sm text-blue-600 dark:text-blue-400 truncate" title={`http://localhost:3000/${url.short_url}`}>
                ...
                <td className="px-6 py-4 text-center">
                  <button
                    onClick={() => copyToClipboard(`http://localhost:3000/${url.short_url}`, url._id)}
